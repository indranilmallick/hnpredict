...
if st.sidebar.button('Manually Update Models'):
    try:
        st.sidebar.write('Trying model update... please be patient.')
        model_update1.create_models()
        st.sidebar.write('Models Updated')
    except: st.sidebar.write("Model creation failed")
...
plots = figure(plot_width=300, plot_height=400, title="Outcome Prediction", tooltips=TOOLTIPS)
...
with col3:
    ...
    st.write('DMFS: Distant-metastasis-free survival; OS: Ocerall survival')
with col4:
