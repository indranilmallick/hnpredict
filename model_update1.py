...
def create_models():
    ...
    surv_dfs = oral[['age', 'primary_grp', 'tsize', 'depth', 'diff', 'marginstatus', 'lvi_grp', 'pni_grp', 'n_ipsi_total', 'n_contra_total', 'ece_grp', 'failure_months', 'any_fail']]
    surv_lrc = oral[['age', 'primary_grp', 'tsize', 'depth', 'diff', 'marginstatus', 'lvi_grp', 'pni_grp', 'n_ipsi_total', 'n_contra_total', 'ece_grp', 'failure_lr_months', 'lr_fail']]
    surv_mfs = oral[['age', 'primary_grp', 'tsize', 'depth', 'diff', 'marginstatus', 'lvi_grp', 'pni_grp', 'n_ipsi_total', 'n_contra_total', 'ece_grp', 'failure_met_months', 'met_fail']]
    surv_os = oral[['age', 'primary_grp', 'tsize', 'depth', 'diff', 'marginstatus', 'lvi_grp', 'pni_grp', 'n_ipsi_total', 'n_contra_total', 'ece_grp', 'death_months', 'death_fail']]
    ...
    update.write("Number of training cases: " + str(len(oral))+ " \n")
